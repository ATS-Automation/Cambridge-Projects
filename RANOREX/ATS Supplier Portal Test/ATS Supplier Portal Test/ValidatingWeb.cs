...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '{Right}{Right}{Right}{Right}{PageUp}{PageUp}{PageUp}{PageUp}'.", new RecordItemIndex(1));
            Keyboard.Press("{Right}{Right}{Right}{Right}{PageUp}{PageUp}{PageUp}{PageUp}");
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '{Right}{Right}{Right}{Right}{PageUp}{PageUp}{PageUp}{PageUp}'.", new RecordItemIndex(13));
            Keyboard.Press("{Right}{Right}{Right}{Right}{PageUp}{PageUp}{PageUp}{PageUp}");
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '{Right}{Right}{Right}{Right}{PageUp}{PageUp}{PageUp}{PageUp}'.", new RecordItemIndex(29));
            Keyboard.Press("{Right}{Right}{Right}{Right}{PageUp}{PageUp}{PageUp}{PageUp}");
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '{Right}{Right}{Right}{Right}{PageUp}{PageUp}{PageUp}{PageUp}'.", new RecordItemIndex(39));
            Keyboard.Press("{Right}{Right}{Right}{Right}{PageUp}{PageUp}{PageUp}{PageUp}");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Move item 'LoginATSSupplierPortal.BtnSubmit' at Center.", repo.LoginATSSupplierPortal.BtnSubmitInfo, new RecordItemIndex(40));
            repo.LoginATSSupplierPortal.BtnSubmit.MoveTo();
            Delay.Milliseconds(200);
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'LoginATSSupplierPortal.BtnSubmit' at Center.", repo.LoginATSSupplierPortal.BtnSubmitInfo, new RecordItemIndex(42));
            repo.LoginATSSupplierPortal.BtnSubmit.Click();
            Delay.Milliseconds(200);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating Exists on item 'LoginATSSupplierPortal.PromiseDateMustBeAFutureDate'.", repo.LoginATSSupplierPortal.PromiseDateMustBeAFutureDateInfo, new RecordItemIndex(43));
            Validate.Exists(repo.LoginATSSupplierPortal.PromiseDateMustBeAFutureDateInfo);
            Delay.Milliseconds(0);
            
            Report.Screenshot(ReportLevel.Info, "User", "", repo.LoginATSSupplierPortal.PromiseDateMustBeAFutureDate, false, new RecordItemIndex(44));
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'LoginATSSupplierPortal.DetailPrice' at Center.", repo.LoginATSSupplierPortal.DetailPriceInfo, new RecordItemIndex(45));
            repo.LoginATSSupplierPortal.DetailPrice.Click();
            Delay.Milliseconds(200);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '{LControlKey down}{Akey}{LControlKey up}{Delete}' with focus on 'LoginATSSupplierPortal.DetailPrice'.", repo.LoginATSSupplierPortal.DetailPriceInfo, new RecordItemIndex(46));
            repo.LoginATSSupplierPortal.DetailPrice.PressKeys("{LControlKey down}{Akey}{LControlKey up}{Delete}");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'RFQListingATSSupplierPortal.PromiseDateText' at Center.", repo.RFQListingATSSupplierPortal.PromiseDateTextInfo, new RecordItemIndex(47));
            repo.RFQListingATSSupplierPortal.PromiseDateText.Click();
            Delay.Milliseconds(200);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'LoginATSSupplierPortal.DivTagSuppl' at Center.", repo.LoginATSSupplierPortal.DivTagSupplInfo, new RecordItemIndex(48));

...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'MainWindow.NavigationPanel.createRFQ1' at Center.", repo.MainWindow.NavigationPanel.createRFQ1Info, new RecordItemIndex(0));
            repo.MainWindow.NavigationPanel.createRFQ1.Click();
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'MainWindow.NavigationPanel.RequiredDateRadioButton' at Center.", repo.MainWindow.NavigationPanel.RequiredDateRadioButtonInfo, new RecordItemIndex(3));
            repo.MainWindow.NavigationPanel.RequiredDateRadioButton.Click();
            Delay.Milliseconds(200);
            
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Text to '90000' on item 'MainWindow.NavigationPanel.UserReferenceFilter'.", repo.MainWindow.NavigationPanel.UserReferenceFilterInfo, new RecordItemIndex(4));
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'MainWindow.NavigationPanel.BulkReqDateTextBox' at Center.", repo.MainWindow.NavigationPanel.BulkReqDateTextBoxInfo, new RecordItemIndex(8));
            repo.MainWindow.NavigationPanel.BulkReqDateTextBox.Click();
            Delay.Milliseconds(200);
            
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Text to '' on item 'MainWindow.NavigationPanel.BulkReqDateTextBox'.", repo.MainWindow.NavigationPanel.BulkReqDateTextBoxInfo, new RecordItemIndex(9));
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Text to '$varDate' on item 'MainWindow.NavigationPanel.BulkReqDateTextBox'.", repo.MainWindow.NavigationPanel.BulkReqDateTextBoxInfo, new RecordItemIndex(11));
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'MainWindow.NavigationPanel.ApplyToSelected' at Center.", repo.MainWindow.NavigationPanel.ApplyToSelectedInfo, new RecordItemIndex(13));
            repo.MainWindow.NavigationPanel.ApplyToSelected.Click();
            Delay.Milliseconds(200);
            
            Report.Screenshot(ReportLevel.Info, "User", "", repo.MainWindow.NavigationPanel.BulkReqDateTextBox, false, new RecordItemIndex(14));
            ...
            Report.Screenshot(ReportLevel.Info, "User", "", repo.MainWindow.NavigationPanel.tabPageList, false, new RecordItemIndex(17));

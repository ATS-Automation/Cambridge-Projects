...
/*		public void ReadDataFile(string datafilepath, out bool EQA, out bool EDV, out bool IQA, out bool IDV)
        ...
        //   ReadDataFile(datapath, out EQA, out EDV, out IQA, out IDV);
           try 
           {
           	...
           	subject = "Build To Print Regression Test Run Config: " + TestSuite.Current.SelectedRunConfig.Name.ToString() + " - " + sResult;
            	
            	if (sResult == "Passed")
            	{
            		addressTo = "anpatel@atsautomation.com; abridgman@atsautomation.com; sageorge@atsautomation.com; chenderson@atsautomation.com";
            	...
            	if (System.IO.File.Exists(reportPath))
           		{
            		...
            		MailHelper.SendMessage(body, addressTo, subject, "relay2.atsna.atsauto.net", addressFrom, "BTP Test", new [] { reportPath });

...
*/        
        ...
        public void SendMail(string reportPath)
        {
            ...
            try 
            {
            		...
            		subject = "JDE Heartbeat Test config: " + TestSuite.Current.SelectedRunConfig.Name.ToString() + " " + Environment.MachineName +  "_" + sResult;
            	...
            	if (System.IO.File.Exists(reportPath))
           		{
           		 	...
           		 	MailHelper.SendMessage(body, addressTo, subject, "relay2.atsna.atsauto.net", addressFrom, "JDE Heartbeat Test", new [] { reportPath });
           		 	MovePDF(reportPath);

...
namespace Ranorex.AutomationHelpers.Modules
{
    ...
    public sealed class EmailModule : ITestModule
    {
        ...
        public EmailModule()
        {
            this.From = "ranorexrt@atsautomation.com";
            this.Body = "";
            this.Password = "_Dd}fTWA*b6P2tm5";

            this.ServerHostname = "relay2.atsna.atsauto.net";
            this.ServerPort = "25";
            this.UseSSL = false.ToString();
            this.Username = "ranorexrt";
        ...
        [TestVariable("0b298785-0c28-4382-bf4d-d95b728e5d16")]
        public string varAttachment { get; set; }
        ...
        private void OnTestSuiteCompletedSendResult(object sender, EventArgs e)
        {
            ...
            {
            	if (System.IO.File.Exists(this.varAttachment))
            	    {
            	    ...
            	    {
            	    	EmailLibrary.SendEmail(
            	    		"BPC Report Generation Unsuccessful",
            	    		this.To,
            	    		this.From,

...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left DoubleClick item 'MainWindow.NavigationPanel.ATSOrigPromDate' at Center.", repo.MainWindow.NavigationPanel.ATSOrigPromDateInfo, new RecordItemIndex(18));
            repo.MainWindow.NavigationPanel.ATSOrigPromDate.DoubleClick();
            Delay.Milliseconds(200);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '01/01/25' with focus on 'MainWindow.NavigationPanel.ATSOrigPromDateFrom'.", repo.MainWindow.NavigationPanel.ATSOrigPromDateFromInfo, new RecordItemIndex(19));
            repo.MainWindow.NavigationPanel.ATSOrigPromDateFrom.PressKeys("01/01/25");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'MainWindow.NavigationPanel.ATSOrigPromDateTo' at Center.", repo.MainWindow.NavigationPanel.ATSOrigPromDateToInfo, new RecordItemIndex(20));
            repo.MainWindow.NavigationPanel.ATSOrigPromDateTo.Click();
            Delay.Milliseconds(200);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '01/15/25' with focus on 'MainWindow.NavigationPanel.ATSOrigPromDateTo'.", repo.MainWindow.NavigationPanel.ATSOrigPromDateToInfo, new RecordItemIndex(21));
            ...
            Report.Log(ReportLevel.Info, "Get Value", "Getting attribute 'Text' from item 'MainWindow.NavigationPanel.ATSOrigPromDateTo' and assigning its value to variable 'valueOfCell'.", repo.MainWindow.NavigationPanel.ATSOrigPromDateToInfo, new RecordItemIndex(23));
            ...
            Report.Screenshot(ReportLevel.Info, "User", "", repo.MainWindow.NavigationPanel.tabPageList, false, new RecordItemIndex(26));

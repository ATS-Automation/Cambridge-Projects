...
//		
		public void SendMail(string reportPath)
        {
            ...
            try 
            {
            	...
            	subject = "Mechanical Deploy Test in the " + TestSuite.Current.Parameters["RunEnvironment"].ToString() + " environment Test Config: " + TestSuite.Current.SelectedRunConfig.Name.ToString() + " " + sResult;

            	if (sResult == "Passed")
            	{
            		addressTo = "anpatel@atsautomation.com; abridgman@atsautomation.com; mcampbell@atsautomation.com; chenderson@atsautomation.com; ecaulfield@atsautomation.com; brhill@atsautomation.com; stauqeer@atsautomation.com;";
            	//	addressTo = "anpatel@atsautomation.com; ecaulfield@atsautomation.com;";
            	}
            	else
            	{
            		addressTo = "anpatel@atsautomation.com; ecaulfield@atsautomation.com;";

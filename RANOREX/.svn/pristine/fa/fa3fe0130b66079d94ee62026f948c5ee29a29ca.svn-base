   ...
   /*     string _durationofTestCase = "0";
        ...
        public void SendMail(string reportPath)
        {
            ...
            try 
            {
            		...
            		subject = "SharePoint Oauth: " + TestSuite.Current.SelectedRunConfig.Name.ToString() + " on " + Environment.MachineName + " " + sResult;
            	

            	
            		addressTo = "anpatel@atsautomation.com; mmahida@atsautomation.com; brhill@atsautomation.com; smotilal@atsautomation.com; rtadepalli@atsautomation.com";
            	...
            	if (System.IO.File.Exists(reportPath))
           		{
           		 	...
           		 	MailHelper.SendMessage(body, addressTo, subject, "relay2.atsna.atsauto.net", addressFrom, "Ranorex Automation", new [] { reportPath });
           		 	MovePDF(reportPath);
        ...
        {
        	string PDFfolderpath = @"\\ca01a9001\pgmis\Deployment\Ranorex\OauthDance\PDF";
